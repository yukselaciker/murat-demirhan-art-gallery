...
export function Contact() {
    const { t } = useLanguage();
    const { data: publicData } = usePublicDataQuery(); // REACT QUERY
    const contactInfo = publicData?.contactInfo || {};
                    ...
                    <div className="contact__info slide-in-left">
                        ...
                        <div className="contact__details">
                            <div className="contact__detail-item">
                                ...
                                <span className="contact__detail-text">{contactInfo.email}</span>
                            </div>
                            <div className="contact__detail-item">
                                <svg className="contact__detail-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="contact__detail-text">{contactInfo.location}</span>
                            </div>
                            {contactInfo.phone && (
                                <div className="contact__detail-item">
                                    <svg className="contact__detail-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span className="contact__detail-text">{contactInfo.phone}</span>
                                </div>
                            )}
                        </div>
                    </div>
